                ...
                <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                    ...
                    <div className="md:flex">
                        <div className="form-control">
                            ...
                            <input type="text" {...register("company")} placeholder="Company Name" className="input input-bordered" />
                        </div>
                        <div className="form-control md:ml-3">
                            <label className="label">
                                <span className="label-text">Country</span>
                            </label>
                            <input type="text" {...register("country")} placeholder="Country" className="input input-bordered" />
                        </div>
                    </div>
                    <div className="form-control">
                        <label className="label">
